...
export default function HeroGeometric({
  ...
  bg-gradient-to-br from-indigo-500/5 via-transparent to-rose-500/5 
  dark:from-indigo-500/10 dark:via-transparent dark:to-rose-500/10"
      />
  ...
  text-black/60 dark:text-white/60"
    ...
    dark:from-white dark:to-white/80"
              ...
              <span
                className={cn(
                  "bg-clip-text text-transparent bg-gradient-to-r  from-black/80 via-black/60 to-gray-700  dark:from-indigo-300 dark:via-white/90 dark:to-rose-300 ",
                  pacifico.className
                )}
              >
                {title2}
  ...
  mb-8 leading-relaxed font-light tracking-wide 
  max-w-xl mx-auto px-4"
            >
              Unlock your full potential with innovative learning strategies and
  ...
  dark:from-[#030303] dark:via-transparent dark:to-[#030303]/80 
  pointer-events-none"
      />
    </div>
  );
